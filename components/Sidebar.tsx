  ...
  return (
    <aside className="w-64 h-full bg-white border-r border-slate-200 flex flex-col shadow-xl z-20 flex-shrink-0 select-none">
      <div className="p-4 border-b border-slate-100 bg-white">
        ...
        <button
          onClick={onOpenAi}
          className="mt-3 w-full bg-gradient-to-r from-indigo-600 to-violet-600 text-white py-2.5 px-3 rounded-lg shadow-md hover:shadow-indigo-200 hover:-translate-y-0.5 transition-all duration-200 flex items-center justify-center gap-2 font-bold text-xs"
        >
